	...
	<div class="blogpostcategory <?php if( ($i) % 2 == 0) echo 'last';?>">					
		<?php if(baltazar_getImage(get_the_id(), 'baltazar-postGridBlock') != '') { ?>	
			...
			<div class="blogimage">	
				...
				<a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title(); ?>"><?php echo baltazar_getImage(get_the_id(), 'baltazar-postGridBlock'); ?></a>
			</div>
			<?php } ?>
			<?php get_template_part('includes/loops/loop-blog-grid','single'); ?>
	</div>
