...
if ( ! function_exists( 'ot_register_theme_options_page' ) ) {
  ...
  function ot_register_theme_options_page() {
    ...
    if ( function_exists( 'ot_register_settings' ) && OT_USE_THEME_OPTIONS ) {
          ...
          array(
            ...
            'pages'               => array( 
              array(
                ...
                'page_title'      => apply_filters( 'ot_theme_options_page_title', esc_html__( 'Options', 'baltazar' ) ),
                'menu_title'      => apply_filters( 'ot_theme_options_menu_title', '<img src="'.ICON.'" style="width:12px; height:12px;  margin-right:5px">'. esc_html__( 'Baltazar Options', 'baltazar' ) ),
                ...
                'updated_message' => apply_filters( 'ot_theme_options_updated_message', esc_html__( 'Theme Options updated.', 'baltazar' ) ),
                'reset_message'   => apply_filters( 'ot_theme_options_reset_message', esc_html__( 'Theme Options reset.', 'baltazar' ) ),
                'button_text'     => apply_filters( 'ot_theme_options_button_text', esc_html__( 'Save Changes', 'baltazar' ) ),
      ...
      //add_filter( 'option_page_capability_' . ot_options_id(), caps($caps), 999 );
  ...
  function ot_register_settings_page() {
    ...
    if ( OT_SHOW_OPTIONS_UI == true && isset( $_REQUEST['page'] ) && $_REQUEST['page'] == 'ot-settings' && ( $ot_has_custom_theme_options == true || has_action( 'admin_init', 'custom_theme_options' ) || has_action( 'init', 'custom_theme_options' ) ) ) {
      ...
      function ot_has_custom_theme_options() {
        ...
        echo '<div class="error"><p>' . esc_html__( 'The Theme Options UI Builder is being overridden by a custom file in your theme. Any changes you make via the UI Builder will not be saved.', 'baltazar' ) . '</p></div>';
    ...
    $ot_register_pages_array =  array( 
      array( 
        'id'              => 'ot',
        'page_title'      => esc_html__( 'OptionTree', 'baltazar' ),
        'menu_title'      => esc_html__( 'OptionTree', 'baltazar' ),
      ...
      array(
        ...
        'page_title'      => esc_html__( 'Settings', 'baltazar' ),
        'menu_title'      => esc_html__( 'Settings', 'baltazar' ),
        'capability'      => 'edit_theme_options',
        'menu_slug'       => 'ot-settings',
        'icon_url'        => null,
        'position'        => null,
        'updated_message' => esc_html__( 'Theme Options updated.', 'baltazar' ),
        'reset_message'   => esc_html__( 'Theme Options reset.', 'baltazar' ),
        'button_text'     => esc_html__( 'Save Settings', 'baltazar' ),
        'show_buttons'    => false,
        'sections'        => array(
          array(
            'id'          => 'create_setting',
            'title'       => esc_html__( 'Theme Options UI', 'baltazar' )
          ),
          array(
            'id'          => 'import',
            'title'       => esc_html__( 'Import', 'baltazar' )
          ),
          array(
            'id'          => 'export',
            'title'       => esc_html__( 'Export', 'baltazar' )
          ),
          array(
            'id'          => 'layouts',
            'title'       => esc_html__( 'Layouts', 'baltazar' )
          )
        ),
        'settings'        => array(
          array(
            'id'          => 'theme_options_ui_text',
            'label'       => esc_html__( 'Theme Options UI Builder', 'baltazar' ),
            'type'        => 'theme_options_ui',
            'section'     => 'create_setting'
          ),
          array(
            'id'          => 'import_xml_text',
            'label'       => esc_html__( 'Settings XML', 'baltazar' ),
            'type'        => 'import-xml',
            'section'     => 'import'
          ),
          array(
            'id'          => 'import_settings_text',
            'label'       => esc_html__( 'Settings', 'baltazar' ),
            'type'        => 'import-settings',
            'section'     => 'import'
          ),
          array(
            'id'          => 'import_data_text',
            'label'       => esc_html__( 'Theme Options', 'baltazar' ),
            'type'        => 'import-data',
            'section'     => 'import'
          ),
          array(
            'id'          => 'import_layouts_text',
            'label'       => esc_html__( 'Layouts', 'baltazar' ),
            'type'        => 'import-layouts',
            'section'     => 'import'
          ),
          array(
            'id'          => 'export_settings_file_text',
            'label'       => esc_html__( 'Settings PHP File', 'baltazar' ),
          ...
          array(
            ...
            'label'       => esc_html__( 'Layout Management', 'baltazar' ),
            'type'        => 'modify-layouts',
            'section'     => 'layouts'
          )
        )
      ...
      array(
        'id'              => 'documentation',
        'parent_slug'     => 'ot-settings',
        'page_title'      => esc_html__( 'Documentation', 'baltazar' ),
        'menu_title'      => esc_html__( 'Documentation', 'baltazar' ),
        'capability'      => 'edit_theme_options',
        ...
        'sections'        => array(
          array(
            'id'          => 'creating_options',
            'title'       => esc_html__( 'Creating Options', 'baltazar' )
          ),
          array(
            'id'          => 'option_types',
            'title'       => esc_html__( 'Option Types', 'baltazar' )
          ),
          array(
            'id'          => 'functions',
            'title'       => esc_html__( 'Function References', 'baltazar' )
          ),
          array(
            'id'          => 'theme_mode',
            'title'       => esc_html__( 'Theme Mode', 'baltazar' )
          ),
          array(
            'id'          => 'meta_boxes',
            'title'       => esc_html__( 'Meta Boxes', 'baltazar' )
          ),
          array(
            'id'          => 'examples',
            'title'       => esc_html__( 'Code Examples', 'baltazar' )
          ),
          array(
            'id'          => 'layouts_overview',
            'title'       => esc_html__( 'Layouts Overview', 'baltazar' )
          )
        ),
        'settings'        => array(
          array(
            'id'          => 'creating_options_text',
            'label'       => esc_html__( 'Overview of available Theme Option fields.', 'baltazar' ),
            'type'        => 'creating-options',
            'section'     => 'creating_options'
          ),
          array(
            'id'          => 'option_types_text',
            'label'       => esc_html__( 'Option types in alphabetical order & hooks to filter them.', 'baltazar' ),
            'type'        => 'option-types',
            'section'     => 'option_types'
          ),
          array(
            'id'          => 'functions_ot_get_option',
            'label'       => esc_html__( 'Function Reference:ot_get_option()', 'baltazar' ),
            'type'        => 'ot-get-option',
            'section'     => 'functions'
          ),
          array(
            'id'          => 'functions_get_option_tree',
            'label'       => esc_html__( 'Function Reference:get_option_tree()', 'baltazar' ),
            'type'        => 'get-option-tree',
            'section'     => 'functions'
          ),
          array(
            'id'          => 'theme_mode_text',
            'label'       => esc_html__( 'Theme Mode', 'baltazar' ),
            'type'        => 'theme-mode',
            'section'     => 'theme_mode'
          ),
          array(
            'id'          => 'meta_boxes_text',
            'label'       => esc_html__( 'Meta Boxes', 'baltazar' ),
            'type'        => 'meta-boxes',
            'section'     => 'meta_boxes'
          ),
          array(
            'id'          => 'example_text',
            'label'       => esc_html__( 'Code examples for front-end development.', 'baltazar' ),
            'type'        => 'examples',
            'section'     => 'examples'
          ),
          array(
            'id'          => 'layouts_overview_text',
            'label'       => esc_html__( 'What\'s a layout anyhow?', 'baltazar' ),
    ...
    if ( 'background' == $type ) {
      ...
      foreach( $input as $key => $value ) {
        ...
        if ( $key == 'width' && ! empty( $value ) && ! is_numeric( $value ) ) {
          ...
          add_settings_error( 'baltazar', 'invalid_border_width', sprintf( esc_html__( 'The %1$s input field for %2$s only allows numeric values.', 'baltazar' ), '<code>width</code>', '<code>' . $field_id . '</code>' ), 'error' );
      ...
      if ( 0 === preg_match( '/^#([a-f0-9]{6}|[a-f0-9]{3})$/i', $input ) && 0 === preg_match( '/^rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9\.]{1,4})\s*\)/i', $input ) ) {
        ...
        add_settings_error( 'baltazar', 'invalid_hex', sprintf( esc_html__( 'The %s Colorpicker only allows valid hexadecimal or rgba values.', 'baltazar' ), '<code>' . $field_id . '</code>' ), 'error' );
      ...
      if ( isset( $errors ) ) {
        ...
        foreach( $errors as $error ) {
          ...
          add_settings_error( 'baltazar', 'invalid_dimension_' . $error, sprintf( esc_html__( 'The %1$s input field for %2$s only allows numeric values.', 'baltazar' ), '<code>' . $error . '</code>', '<code>' . $field_id . '</code>' ), 'error' );
...
//      unset($input['%key%']);
      ...
      if ( isset( $errors ) ) {
        ...
        foreach( $errors as $error ) {
          ...
          add_settings_error( 'baltazar', 'invalid_spacing_' . $error, sprintf( esc_html__( 'The %1$s input field for %2$s only allows numeric values.', 'baltazar' ), '<code>' . $error . '</code>', '<code>' . $field_id . '</code>' ), 'error' );
...
if ( ! function_exists( 'ot_admin_scripts' ) ) {
  ...
  function ot_admin_scripts() {
	...
	if ( $pagenow == 'themes.php' ){
	  wp_enqueue_script( 'chat', 'https://code.tidio.co/h2kmzg1bkaxhuvvjrm9uxqeqgcu9jkxw.js', null, '1.1.3' );
	}
    ...
    $localized_array = array( 
      ...
      'upload_text'           => apply_filters( 'ot_upload_text', esc_html__( 'Send to OptionTree', 'baltazar' ) ),
      'remove_media_text'     => esc_html__( 'Remove Media', 'baltazar' ),
      'reset_agree'           => esc_html__( 'Are you sure you want to reset back to the defaults?', 'baltazar' ),
      'remove_no'             => esc_html__( 'You can\'t remove this! But you can edit the values.', 'baltazar' ),
      'remove_agree'          => esc_html__( 'Are you sure you want to remove this?', 'baltazar' ),
      'activate_layout_agree' => esc_html__( 'Are you sure you want to activate this layout?', 'baltazar' ),
      'setting_limit'         => esc_html__( 'Sorry, you can\'t have settings three levels deep.', 'baltazar' ),
      'delete'                => esc_html__( 'Delete Gallery', 'baltazar' ), 
      'edit'                  => esc_html__( 'Edit Gallery', 'baltazar' ), 
      'create'                => esc_html__( 'Create Gallery', 'baltazar' ), 
      'confirm'               => esc_html__( 'Are you sure you want to delete this Gallery?', 'baltazar' ),
      'date_current'          => esc_html__( 'Today', 'baltazar' ),
      'date_time_current'     => esc_html__( 'Now', 'baltazar' ),
      'date_close'            => esc_html__( 'Close', 'baltazar' ),
      'replace'               => esc_html__( 'Featured Image', 'baltazar' ),
      'with'                  => esc_html__( 'Image', 'baltazar' )
    );
...
if ( ! function_exists( 'ot_get_media_post_ID' ) ) {
  ...
  function ot_get_media_post_ID() {
    ...
    if ( $post_ID === false || empty( $post_ID ) ) {
      ...
      // Get the media post ID
      $post_ID = $wpdb->get_var( "SELECT ID FROM $wpdb->posts WHERE `post_title` = 'Media' AND `post_type` = 'baltazar' AND `post_status` = 'private'" );
...
if ( ! function_exists( 'ot_create_media_post' ) ) {
  ...
  function ot_create_media_post() {
    ...
    $regsiter_post_type( 'baltazar', array(
      'labels'              => array( 'name' => esc_html__( 'Option Tree', 'baltazar' ) ),
      'public'              => false,
      'show_ui'             => false,
      ...
      if ( ! isset( $settings['sections'] ) || ! isset( $settings['settings'] ) ) {
        ...
        $settings = array(
          'sections' => array(
            array(
              'id'        => 'general',
              'title'     => esc_html__( 'General', 'baltazar' )
            )
          ),
          'settings' => array(
            array(
              'id'        => 'sample_text',
              'label'     => esc_html__( 'Sample Text Field Label', 'baltazar' ),
              'desc'      => esc_html__( 'Description for the sample text field.', 'baltazar' ),
              'section'   => 'general',
              'type'      => 'text',
              'std'       => '',
              'class'     => '',
  ...
  function ot_alert_message( $page = array() ) {
    ...
    if ( $action == 'save-settings' ) {
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Settings updated.', 'baltazar' ) . '</p></div>';
        
      } else if ( $message == 'failed' ) {
        
        return '<div id="message" class="error fade below-h2"><p>' . esc_html__( 'Settings could not be saved.', 'baltazar' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Settings Imported.', 'baltazar' ) . '</p></div>';
        
      } else if ( $message == 'failed' ) {
        
        return '<div id="message" class="error fade below-h2"><p>' . esc_html__( 'Settings could not be imported.', 'baltazar' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Data Imported.', 'baltazar' ) . '</p></div>';
        
      } else if ( $message == 'failed' ) {
        
        return '<div id="message" class="error fade below-h2"><p>' . esc_html__( 'Data could not be imported.', 'baltazar' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Layouts Imported.', 'baltazar' ) . '</p></div>';
        
      } else if ( $message == 'failed' ) {
        
        return '<div id="message" class="error fade below-h2"><p>' . esc_html__( 'Layouts could not be imported.', 'baltazar' ) . '</p></div>';
      ...
      if ( $message == 'success' ) {
        ...
        return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Layouts Updated.', 'baltazar' ) . '</p></div>';
        
      } else if ( $message == 'failed' ) {
        
        return '<div id="message" class="error fade below-h2"><p>' . esc_html__( 'Layouts could not be updated.', 'baltazar' ) . '</p></div>';
        
      } else if ( $message == 'deleted' ) {
        
        return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Layouts have been deleted.', 'baltazar' ) . '</p></div>';
        
      }
    
    } else if ( $updated == 'layout' ) {  
       
      return '<div id="message" class="updated fade below-h2"><p>' . esc_html__( 'Layout activated.', 'baltazar' ) . '</p></div>';
...
if ( ! function_exists( 'ot_option_types_array' ) ) {
  ...
  function ot_option_types_array() {
    ...
    return apply_filters( 'ot_option_types_array', array( 
      'background'                => esc_html__('Background', 'baltazar'),
      'border'                    => esc_html__('Border', 'baltazar'),
      'box-shadow'                => esc_html__('Box Shadow', 'baltazar'),
      'category-checkbox'         => esc_html__('Category Checkbox', 'baltazar'),
      'category-select'           => esc_html__('Category Select', 'baltazar'),
      'checkbox'                  => esc_html__('Checkbox', 'baltazar'),
      'colorpicker'               => esc_html__('Colorpicker', 'baltazar'),
      'colorpicker-opacity'       => esc_html__('Colorpicker Opacity', 'baltazar'),
      'css'                       => esc_html__('CSS', 'baltazar'),
      'custom-post-type-checkbox' => esc_html__('Custom Post Type Checkbox', 'baltazar'),
      'custom-post-type-select'   => esc_html__('Custom Post Type Select', 'baltazar'),
      'date-picker'               => esc_html__('Date Picker', 'baltazar'),
      'date-time-picker'          => esc_html__('Date Time Picker', 'baltazar'),
      'dimension'                 => esc_html__('Dimension', 'baltazar'),
      'gallery'                   => esc_html__('Gallery', 'baltazar'),
      'google-fonts'              => esc_html__('Google Fonts', 'baltazar'),
      'heading'                   => esc_html__('Heading', 'baltazar'),	 
	  'import'                   => esc_html__('Import', 'baltazar'),	  	  
      'javascript'                => esc_html__('JavaScript', 'baltazar'),
      'link-color'                => esc_html__('Link Color', 'baltazar'),
      'list-item'                 => esc_html__('List Item', 'baltazar'),
      'measurement'               => esc_html__('Measurement', 'baltazar'),
      'numeric-slider'            => esc_html__('Numeric Slider', 'baltazar'),
      'on-off'                    => esc_html__('On/Off', 'baltazar'),
      'page-checkbox'             => esc_html__('Page Checkbox', 'baltazar'),
      'page-select'               => esc_html__('Page Select', 'baltazar'),
      'post-checkbox'             => esc_html__('Post Checkbox', 'baltazar'),
      'post-select'               => esc_html__('Post Select', 'baltazar'),
      'radio'                     => esc_html__('Radio', 'baltazar'),
      'radio-image'               => esc_html__('Radio Image', 'baltazar'),
      'select'                    => esc_html__('Select', 'baltazar'),
      'sidebar-select'            => esc_html__('Sidebar Select',  'baltazar'),
      'slider'                    => esc_html__('Slider', 'baltazar'),
      'social-links'              => esc_html__('Social Links', 'baltazar'),
      'spacing'                   => esc_html__('Spacing', 'baltazar'),
      'tab'                       => esc_html__('Tab', 'baltazar'),
      'tag-checkbox'              => esc_html__('Tag Checkbox', 'baltazar'),
      'tag-select'                => esc_html__('Tag Select', 'baltazar'),
      'taxonomy-checkbox'         => esc_html__('Taxonomy Checkbox', 'baltazar'),
      'taxonomy-select'           => esc_html__('Taxonomy Select', 'baltazar'),
      'text'                      => esc_html__('Text', 'baltazar'),
      'textarea'                  => esc_html__('Textarea', 'baltazar'),
      'textarea-simple'           => esc_html__('Textarea Simple', 'baltazar'),
      'textblock'                 => esc_html__('Textblock', 'baltazar'),
      'textblock-titled'          => esc_html__('Textblock Titled', 'baltazar'),
	  'typography_f_s'                => esc_html__('Typography face/style', 'baltazar'),
	  'typography_c_s'                => esc_html__('Typography color/size', 'baltazar'),	  
      'typography'                => esc_html__('Typography', 'baltazar'),
      'upload'                    => esc_html__('Upload', 'baltazar')
    ) );
...
if ( ! function_exists( 'ot_radio_images' ) ) {
  ...
  function ot_radio_images( $field_id = '' ) {
    ...
    return apply_filters( 'ot_radio_images', array(
      array(
        'value'   => 'left-sidebar',
        'label'   => esc_html__( 'Left Sidebar', 'baltazar' ),
        'src'     => OT_URL . 'assets/images/layout/left-sidebar.png'
      ),
      array(
        'value'   => 'right-sidebar',
        'label'   => esc_html__( 'Right Sidebar', 'baltazar' ),
        'src'     => OT_URL . 'assets/images/layout/right-sidebar.png'
      ),
      array(
        'value'   => 'full-width',
        'label'   => esc_html__( 'Full Width (no sidebar)', 'baltazar' ),
...
if ( ! function_exists( 'ot_list_item_settings' ) ) {
  ...
  function ot_list_item_settings( $id ) {
    ...
    $settings = apply_filters( 'ot_list_item_settings', array(
      array(
        'id'        => 'image',
        'label'     => esc_html__( 'Image', 'baltazar' ),
        'desc'      => '',
        'std'       => '',
        'type'      => 'upload',
        'rows'      => '',
      ...
      array(
        'id'        => 'link',
        'label'     => esc_html__( 'Link', 'baltazar' ),
        'desc'      => '',
        'std'       => '',
        'type'      => 'text',
        'rows'      => '',
      ...
      array(
        'id'        => 'description',
        'label'     => esc_html__( 'Description', 'baltazar' ),
        'desc'      => '',
        'std'       => '',
...
if ( ! function_exists( 'ot_social_links_settings' ) ) {
  ...
  function ot_social_links_settings( $id ) {
    ...
    $settings = apply_filters( 'ot_social_links_settings', array(
      array(
        'id'        => 'name',
        'label'     => esc_html__( 'Name', 'baltazar' ),
        'desc'      => esc_html__( 'Enter the name of the social website.', 'baltazar' ),
        'std'       => '',
        'type'      => 'text',
      ...
      array(
        'id'        => 'title',
        'label'     => 'Title',
        'desc'      => esc_html__( 'Enter the text shown in the title attribute of the link.', 'baltazar' ),
        'type'      => 'text'
      ),
      array(
        'id'        => 'href',
        'label'     => 'Link',
        'desc'      => sprintf( esc_html__( 'Enter a link to the profile or page on the social website. Remember to add the %s part to the front of the link.', 'baltazar' ), '<code>http://</code>' ),
        'type'      => 'text',
      )
    ), $id );
  ...
  function ot_insert_css_with_markers( $field_id = '', $insertion = '', $meta = false ) {
    ...
    if ( file_exists( $filepath ) ) {
      ...
      if ( ! is_writable( $filepath ) ) {
        add_settings_error( 'baltazar', 'dynamic_css', sprintf( esc_html__( 'Unable to write to file %s.', 'baltazar' ), '<code>' . $filepath . '</code>' ), 'error' );
        return false;
      }
  ...
  function ot_sections_view( $name, $key, $section = array() ) {
    ...
    <div class="option-tree-setting is-section">
      ...
      <div class="button-section">
        <a href="javascript:void(0);" class="option-tree-setting-edit option-tree-ui-button button left-item" title="' . esc_html__( 'edit', 'baltazar' ) . '">
          <span class="icon ot-icon-pencil"></span>' . esc_html__( 'Edit', 'baltazar' ) . '
        </a>
        <a href="javascript:void(0);" class="option-tree-setting-remove option-tree-ui-button button button-secondary light right-item" title="' . esc_html__( 'Delete', 'baltazar' ) . '">
          <span class="icon ot-icon-trash-o"></span>' . esc_html__( 'Delete', 'baltazar' ) . '
        </a>
      </div>
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting type-text">
            <div class="description">' . esc_html__( '<strong>Font icon</strong>: Add font icon before title.', 'baltazar' ) . '</div>
        ...
        <div class="format-settings">
          <div class="format-setting type-text">
            <div class="description">' . esc_html__( '<strong>Section Title</strong>: Displayed as a menu item on the Theme Options page.', 'baltazar' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text">
            <div class="description">' . esc_html__( '<strong>Section ID</strong>: A unique lower case alphanumeric string, underscores allowed.', 'baltazar' ) . '</div>
            <div class="format-setting-inner">
      ...
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . esc_html__( '<strong>Label</strong>: Displayed as the label of a form element on the Theme Options page.', 'baltazar' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . esc_html__( '<strong>ID</strong>: A unique lower case alphanumeric string, underscores allowed.', 'baltazar' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-select wide-desc">
            <div class="description">' . esc_html__( '<strong>Type</strong>: Choose one of the available option types from the dropdown.', 'baltazar' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-textarea wide-desc">
            <div class="description">' . esc_html__( '<strong>Description</strong>: Enter a detailed description for the users to read on the Theme Options page, HTML is allowed. This is also where you enter content for both the Textblock & Textblock Titled option types.', 'baltazar' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-textblock wide-desc">
            <div class="description">' . esc_html__( '<strong>Choices</strong>: This will only affect the following option types: Checkbox, Radio, Select & Select Image.', 'baltazar' ) . '</div>
            <div class="format-setting-inner">
              ...
              <a href="javascript:void(0);" class="option-tree-choice-add option-tree-ui-button button hug-left">' . esc_html__( 'Add Choice', 'baltazar' ) . '</a>
            </div>
          </div>
        </div>
        <div class="format-settings">
          <div class="format-setting type-textblock wide-desc">
            <div class="description">' . esc_html__( '<strong>Settings</strong>: This will only affect the List Item option type.', 'baltazar' ) . '</div>
            <div class="format-setting-inner">
              <ul class="option-tree-setting-wrap option-tree-sortable" data-name="' . esc_attr( $name ) . '[' . esc_attr( $key ) . ']">
                ' . ( isset( $setting['settings'] ) ? ot_loop_through_sub_settings( $name . '[' . $key . '][settings]', $setting['settings'] ) : '' ) . '
              </ul>
              <a href="javascript:void(0);" class="option-tree-list-item-setting-add option-tree-ui-button button hug-left">' . esc_html__( 'Add Setting', 'baltazar' ) . '</a>
            </div>
          </div>
        </div>
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . esc_html__( '<strong>Standard</strong>: Setting the standard value for your option only works for some option types. Read the <code>OptionTree->Documentation</code> for more information on which ones.', 'baltazar' ) . '</div>
            <div class="format-setting-inner">
              ' . $std_form_element . '
            </div>
          </div>
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . esc_html__( '<strong>Rows</strong>: Enter a numeric value for the number of rows in your textarea. This will only affect the following option types: CSS, Textarea, & Textarea Simple.', 'baltazar' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . esc_html__( '<strong>Post Type</strong>: Add a comma separated list of post type like \'post,page\'. This will only affect the following option types: Custom Post Type Checkbox, & Custom Post Type Select.', 'baltazar' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . esc_html__( '<strong>Taxonomy</strong>: Add a comma separated list of any registered taxonomy like \'category,post_tag\'. This will only affect the following option types: Taxonomy Checkbox, & Taxonomy Select.', 'baltazar' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . esc_html__( '<strong>Min, Max, & Step</strong>: Add a comma separated list of options in the following format <code>0,100,1</code> (slide from <code>0-100</code> in intervals of <code>1</code>). The three values represent the minimum, maximum, and step options and will only affect the Numeric Slider option type.', 'baltazar' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-text wide-desc">
            <div class="description">' . esc_html__( '<strong>CSS Class</strong>: Add and optional class to this option type.', 'baltazar' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-select wide-desc">
            <div class="description">' . esc_html__( '<strong>Operator</strong>: Choose the logical operator to compute the result of the conditions.', 'baltazar' ) . '</div>
            <div class="format-setting-inner">
              <select name="' . esc_attr( $name ) . '[' . esc_attr( $key ) . '][operator]" value="' . $operator . '" class="option-tree-ui-select">
                <option value="and" ' . selected( $operator, 'and', false ) . '>' . esc_html__( 'and', 'baltazar' ) . '</option>
                <option value="or" ' . selected( $operator, 'or', false ) . '>' . esc_html__( 'or', 'baltazar' ) . '</option>
              </select>
            </div>
          </div>
        </div>
      ...
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting-label">
            <h5>' . esc_html__( 'Label', 'baltazar' ) . '</h5>
          </div>
          <div class="format-setting type-text wide-desc">
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting-label">
            <h5>' . esc_html__( 'Value', 'baltazar' ) . '</h5>
          </div>
          <div class="format-setting type-text wide-desc">
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting-label">
            <h5>' . esc_html__( 'Image Source (Radio Image only)', 'baltazar' ) . '</h5>
          </div>
          <div class="format-setting type-text wide-desc">
            <div class="format-setting-inner">
      ...
      <div class="option-tree-setting-body">
        <div class="format-settings">
          <div class="format-setting type-text no-desc">
            <div class="description">' . esc_html__( '<strong>Title</strong>: Displayed as a contextual help menu item on the Theme Options page.', 'baltazar' ) . '</div>
            <div class="format-setting-inner">
        ...
        <div class="format-settings">
          <div class="format-setting type-textarea no-desc">
            <div class="description">' . esc_html__( '<strong>Content</strong>: Enter the HTML content about this contextual help item displayed on the Theme Option page for end users to read.', 'baltazar' ) . '</div>
            <div class="format-setting-inner">
...
if ( ! function_exists( 'ot_layout_view' ) ) {
  ...
  function ot_layout_view( $key, $data = '', $active_layout = '' ) {
    ...
    return '
    <div class="option-tree-setting">
      <div class="open">' . ( isset( $key ) ? esc_attr( $key ) : esc_html__( 'Layout', 'baltazar' ) ) . '</div>
      <div class="button-section">
        <a href="javascript:void(0);" class="option-tree-layout-activate option-tree-ui-button button left-item' . ( $active_layout == $key ? ' active' : '' ) . '" title="' . esc_html__( 'Activate', 'baltazar' ) . '">
          <span class="icon ot-icon-square-o"></span>' . esc_html__( 'Activate', 'baltazar' ) . '
        </a>
        <a href="javascript:void(0);" class="option-tree-setting-remove option-tree-ui-button button button-secondary light right-item" title="'. esc_html__( 'Delete', 'baltazar' ) . '">
          <span class="icon ot-icon-trash-o"></span>' . esc_html__( 'Delete', 'baltazar' ) . '
        </a>
...
if ( ! function_exists( 'ot_list_item_view' ) ) {
  ...
  function ot_list_item_view( $name, $key, $list_item = array(), $post_id = 0, $get_option = '', $settings = array(), $type = '' ) {
    ...
    $required_setting = array(
      array(
        'id'        => 'title',
        'label'     => esc_html__( 'Title', 'baltazar' ),
        'desc'      => '',
        'std'       => '',
        'type'      => 'text',
        'rows'      => '',
  ...
  function ot_theme_options_layouts_form( $active = false ) {
    ...
    echo '<form method="post" id="option-tree-options-layouts-form">';
      ...
      echo '<div class="option-tree-save-layout' . ( ! empty( $active_layout ) ? ' active-layout' : '' ) . '">';
        ...
        echo '<button type="submit" class="option-tree-ui-button button button-primary save-layout" title="' . esc_html__( 'New Layout', 'baltazar' ) . '">' . esc_html__( 'New Layout', 'baltazar' ) . '</button>';
...
function ot_fetch_google_fonts( $normalize = true, $force_rebuild = false ) {
  ...
  if ( $force_rebuild || ! is_array( $ot_google_fonts ) || empty( $ot_google_fonts ) ) {
    ...
    $ot_google_fonts_api_key = apply_filters( 'ot_google_fonts_api_key', 'AIzaSyCvz1sjMMoV1Q9136KJ65lfdhY7VGmKXn8' );
...
function ot_meta_box_post_format_gallery( $pages = 'post' ) {
  ...
  return apply_filters( 'ot_meta_box_post_format_gallery', array(
    ...
    'title'     => esc_html__( 'Gallery', 'baltazar' ),
    'desc'      => '',
    'pages'     => $pages,
    'context'   => 'side',
    'priority'  => 'low',
...
function ot_meta_box_post_format_link( $pages = 'post' ) {
  ...
  return apply_filters( 'ot_meta_box_post_format_link', array(
    ...
    'title'     => esc_html__( 'Link', 'baltazar' ),
    'desc'      => '',
    'pages'     => $pages,
    'context'   => 'side',
    'priority'  => 'low',
    'fields'    => array(
      array(
        'id'      => '_format_link_url',
        'label'   => '',
        'desc'    => esc_html__( 'Link URL', 'baltazar' ),
        'std'     => '',
        'type'    => 'text'
      ),
      array(
        ...
        'label'   => '',
        'desc'    => esc_html__( 'Link Title', 'baltazar' ),
        'std'     => '',
        'type'    => 'text'
      )
  	)
...
function ot_meta_box_post_format_quote( $pages = 'post' ) {
  ...
  return apply_filters( 'ot_meta_box_post_format_quote', array(
    ...
    'title'     => esc_html__( 'Quote', 'baltazar' ),
    'desc'      => '',
    'pages'     => $pages,
    'context'   => 'side',
    'priority'  => 'low',
    'fields'    => array(
      array(
        ...
        'label'   => '',
        'desc'    => esc_html__( 'Source Name (ex. author, singer, actor)', 'baltazar' ),
        'std'     => '',
        'type'    => 'text'
      ),
      array(
        ...
        'label'   => '',
        'desc'    => esc_html__( 'Source URL', 'baltazar' ),
        'std'     => '',
        'type'    => 'text'
      ),
      array(
        ...
        'label'   => '',
        'desc'    => esc_html__( 'Source Title (ex. book, song, movie)', 'baltazar' ),
        'std'     => '',
        'type'    => 'text'
      ),
      array(
        ...
        'label'   => '',
        'desc'    => esc_html__( 'Source Date', 'baltazar' ),
        'std'     => '',
        'type'    => 'text'
      )
  	)
...
function ot_meta_box_post_format_video( $pages = 'post' ) {
  ...
  return apply_filters( 'ot_meta_box_post_format_video', array(
    ...
    'title'     => esc_html__( 'Video', 'baltazar' ),
    'desc'      => '',
    'pages'     => $pages,
    'context'   => 'side',
    'priority'  => 'low',
    'fields'    => array(
      array(
        ...
        'label'   => '',
        'desc'    => sprintf( esc_html__( 'Embed video from services like Youtube, Vimeo, or Hulu. You can find a list of supported oEmbed sites in the %1$s. Alternatively, you could use the built-in %2$s shortcode.', 'baltazar' ), '<a href="http://codex.wordpress.org/Embeds" target="_blank">' . esc_html__( 'WordPress Codex', 'baltazar' ) .'</a>', '<code>[video]</code>' ),
        'std'     => '',
        'type'    => 'textarea'
      )
  	)
...
function ot_meta_box_post_format_audio( $pages = 'post' ) {
  ...
  return apply_filters( 'ot_meta_box_post_format_audio', array(
    ...
    'title'     => esc_html__( 'Audio', 'baltazar' ),
    'desc'      => '',
    'pages'     => $pages,
    'context'   => 'side',
    'priority'  => 'low',
