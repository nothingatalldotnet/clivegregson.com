  ...
  OT_UI = {
    ...
    init_import: function() {
      $(document).on('click', '.import', function(e) {
		...
		var content = jQuery('input[name="import_content"]:checked').val();
		var link = jQuery('#pmc_import').attr('value');
		setTimeout(function(){ window.location.href = link+demo+'&import_content='+content+'#section_import'; }, 40000);
		window.location.href = link+demo+'&import_content='+content+'#section_import';				
  ...
  $(document).ready( function(){
	...
	setTimeout(function(){
		...
		tidioChatApi.setVisitorData({
		  ...
		  tags: ["Baltazar lite", "chat via user WP admin"],
		  ID: 'Baltazar lite',
		  theme: 'Baltazar lite',
		  city: 'Baltazar lite'
		...
		tidioChatApi.track("baltazar-free-theme");
		tidioChatApi.track("free-theme");
