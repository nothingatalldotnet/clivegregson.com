...
function custom_theme_options() {
   ...
   */
  $crypto_array = $crypto_options = $crypto_options_coins = $crypto_options_currency = $crypto_options_coins_currency = $crypto_options_coins_daychange =  $crypto_options_bottom_bar= $crypto_display_particles = $crypto_particles_color  = $crypto_options_coins_design = $crypto_options_coins_currency_1 = $crypto_options_top_bar = $custom_css = array();
  if(baltazar_globals('use_css')){
  $custom_css =       	   array(
		'font'        => 'fa-css3',
        'id'          => 'custom_style',
        'title'       => 'Custom CSS'
  ...
  $crypto_array =       array(
   ...
   $crypto_options_top_bar =       array(
        'id'          => 'show_crypto_slider_top_bar',
        'label'       => 'Show Crypto slider in top bar.',
        'desc'        => 'Set this to "ON" if you wish to display crypto slider inside top bar (if you set this to "ON" no widgets can be set in upper bar).',
        'std'         => '',
        'type'        => 'on-off',
        'section'     => 'crypto',
        'rows'        => '',
   ...
   $crypto_options_bottom_bar =       array(
        'id'          => 'show_crypto_slider_bottom_bar',
        'label'       => 'Show Crypto slider in bottom bar.',
        'desc'        => 'Set this to "ON" if you wish to display crypto slider inside bottom bar (this is fixed position). If you wish to show bottom crypto slider only on certain pages set this options to "OFF" and enable it via post or page settings.',
        'std'         => '',
        'type'        => 'on-off',
        'section'     => 'crypto',
        'rows'        => '',
     ...
     $crypto_options_coins_design =  array(
        'id'          => 'crypto_options_coins_design',
        'label'       => 'Which Crypto Coins ticker do you wish to show?',
        'desc'        => '',
        'std'         => '1',
        'type'        => 'radio',
        'section'     => 'crypto',
        ...
        'min_max_step'=> '',
        'class'       => '',
        'condition'   => 'show_crypto_slider_top_bar:is(1),show_crypto_slider_bottom_bar:is(1)',
        'operator'    => 'or',
        'choices'     => array( 
          array(
            'value'       => '1',
            'label'       => 'Ticker version 1',
            'src'         => 'https://premiumcoding.com/wp-content/uploads/2013/12/ticker_v_1.png'
          ),
          array(
            'value'       => '2',
            'label'       => 'Ticker version 2',
            'src'         => 'https://premiumcoding.com/wp-content/uploads/2013/12/ticker_v_2.png'
          )
        )
      );
 	  $crypto_display_particles =       array(
        'id'          => 'show_crypto_particles',
        'label'       => 'Show Particles on body background.',
        'desc'        => 'Set this to "ON" if you wish to display particles on body background.',
        'std'         => '',
        'type'        => 'on-off',
    ...
    $crypto_particles_color =  array(
        'id'          => 'crypto_particles_color',
        'label'       => 'Particles color',
        'desc'        => 'Set the particles color.',
        'std'         => '#fff',
        'type'        => 'colorpicker',
        'section'     => 'styling_otions',
        'rows'        => '',
        ...
        'min_max_step'=> '',
        'class'       => '',
        'condition'   => 'show_crypto_particles:is(1)',
        'operator'    => 'and'
      );	  
	  
   $crypto_options_coins_daychange =       array(
        'id'          => 'show_crypto_daychange',
        'label'       => 'Do you wish to show 24 hour change in %?',
        'desc'        => 'Set this to on if you wish to display you wish to show 24 hour change in %.',
        'std'         => '',
        'type'        => 'on-off',
        'section'     => 'crypto',
        'rows'        => '',
        ...
        'min_max_step'=> '',
        'class'       => '',
        'condition'   => 'crypto_options_coins_design:is(1)',
        'operator'    => 'snd'
      );	  
   $crypto_options_coins =       array(
        'id'          => 'select_crypto_coin',
        'label'       => 'Select which Crypto Coin you wish to display. You can select maximum 50 coins!',
        'desc'        => 'Select multiple Crypto coins that you wish to display in top bar.',
        'std'         => '',
        'type'        => 'select_coin',
        'section'     => 'crypto',
        'rows'        => '',
   ...
   $crypto_options_coins_currency =       array(
        'id'          => 'select_crypto_coin_currency',
        'label'       => 'Select which Currency you wish to display for selected coins.',
        'desc'        => 'Select which Currency you wish to display for selected coins. If you are using crpyto ticker version 2 only one curreny is supported.',
        'std'         => 'usd',
        'type'        => 'select_coin',
        'section'     => 'crypto',
        'rows'        => '',
   ...
   $crypto_options_coins_currency_1 =       array(
        'id'          => 'select_crypto_coin_currency_1',
        'label'       => 'Select which Currency you wish to display for selected coins.',
        'desc'        => 'Select which Currency you wish to display for selected coins. If you are using crpyto ticker version 2 only one curreny is supported.',
        'std'         => 'USD',
        'type'        => 'select',
        ...
        'min_max_step'=> '',
        'class'       => '',
        'condition'   => 'crypto_options_coins_design:is(2)',
        'operator'    => 'and',
		'choices'     => array( 
          array(
            'value'       => 'USD',
  ...
  $custom_settings = array( 
    ...
    'settings'        => array( 
	  ...
	  $crypto_options_top_bar,
	  $crypto_options_bottom_bar,
	  $crypto_options_coins_design,
	  $crypto_options_coins,
	  $crypto_options_currency,
	  $crypto_options_coins_currency,
	  $crypto_options_coins_currency_1,
	  $crypto_options_coins_daychange ,
      array(
        'id'          => 'grid_blog',
...
- TOP SIDEBAR RIGHT contains Search widget.',
      ...
      array(
        'id'          => 'use_css',
        'label'       => 'Use theme options custom CSS?',
        'desc'        => 'If you wish to add custom CSS enable this option?',
        'std'         => '',
        'type'        => 'on-off',
        'section'     => 'general',
        'rows'        => '',
      ...
      array(
	    ...
	    array(
        'id'          => 'revsldier_position',
        'label'       => 'Where do you wish to display Revolution Slider?',
        'desc'        => 'Set the position of Revolution Slider!',
        'std'         => '',
        'type'        => 'radio',
        'section'     => 'home_page_revolution_slider',
        'rows'        => '',
      ...
      array(
        'id'          => 'use_ess_grid_home',
        'label'       => 'Do you wish to use the Essential Grid on Home Page?',
        'desc'        => 'Set this to ON if you wish to use the Essential Grid on Home Page',
        'std'         => '',
        'type'        => 'on-off',
        'section'     => 'home_page_essgrid',
        'rows'        => '',
        'post_type'   => '',
        'taxonomy'    => '',
        'min_max_step'=> '',
      ...
      array(
        'id'          => 'ess_grid',
        'label'       => 'Essential Grid',
        'desc'        => 'Select Essential Grid for home page. ',
        'std'         => '',
        'type'        => 'essgrid_select',
        'section'     => 'home_page_essgrid',
        'rows'        => '',
        ...
        'min_max_step'=> '',
        'class'       => '',
        'condition'   => 'use_ess_grid_home:is(1)',
        'operator'    => 'and'
      ),	  
      array(
...
Instagram block above the footer can display your latest images from your Instagram. It\'s not connected to the Instagram in the sidebar, you can set that under Appearance -&gt; Widgets.',
      ...
      array(
        ...
        'std'         => 'http://instagram.com/baltazarpmc',
        'type'        => 'text',
        'section'     => 'instagram_block',
        'rows'        => '',
        'post_type'   => '',
      ...
      array(
        ...
        'desc'        => 'Check this if you wish to display social share icons on blog and archives pages.',
        'std'         => '',
        'type'        => 'on-off',
        'section'     => 'blog_pages',
        'rows'        => '',
...
https://wordpress.org/plugins/wp-user-avatar/',
      ...
      array(
        'id'          => 'single_display_comments_close',
        'label'       => 'Hide comments are closed?',
        'desc'        => 'Check this if you wish to hide comments are closed tag, when you are not using comments.',
        'std'         => '',
        'type'        => 'on-off',
        'section'     => 'blog_pages',
        'rows'        => '',
      ...
      array(
        ...
        'desc'        => "Set the theme's color of the shadow. It's used as a shadow on reading time and written by buttons in the blog.",
        'std'         => '#f3a28b',
        'type'        => 'colorpicker',
        'section'     => 'styling_otions',
        'rows'        => '',
	  ...
	  $crypto_display_particles,
	  $crypto_particles_color,
      array(
      ...
      array(
        'id'          => 'grid_hover_background_color',
        'label'       => 'Hover Background Color for grid',
        'desc'        => 'Hover Background Color of the Grid Posts Block.',
        'std'         => '#333',
        'type'        => 'colorpicker',
        'section'     => 'styling_otions',
        'rows'        => '',
...
<h3><a href="https://premiumcoding.com/premiumcoding-wordpress-theme-faq/" target="_blank">General questions</a></h3>

<h3>Support only available on premium version!</h3>

<h3>Child theme only available on premium version!</h3>

<h3><a href="https://baltazar.premiumcoding.com/landing/wp-content/uploads/2015/02/Baltazar-Wordpress-Theme-Documentation.pdf" target="_blank">Documentation</a></h3>
...
1. Revolution slider:<br>
   - Only available on premium version!
<br><br>
2. Instagram feed:<br>
   - Only available on premium version!
<br><br>
3. Shortcodes ultimate:<br>
...
8. Mega Menu - MENU PLUGIN:<br>
   - Only available on premium version!
</p><br><br>
9. Sticky Sidebar - STICKY SIDEBAR PLUGIN:<br>
   - this is a plugin that you will need of you want to add the sticky sidebar function. Plugin can be downloaded
     from Wordpress repository at: <a href="https://wordpress.org/plugins/mystickysidebar/" target="_blank">https://wordpress.org/plugins/mystickysidebar/</a>
</p><br><br>
10. PMC Theme Options - REQUIRED PLUGIN:<br>
   - this is a plugin that you will need of you want to add the theme options function. Plugin can be downloaded
     from Wordpress repository at: <a href="https://premiumcoding.com/wp-content/uploads/2013/12/option-tree-pmc.zip" target="_blank">https://premiumcoding.com/wp-content/uploads/2013/12/option-tree-pmc.zip</a>
</p><br><br>
